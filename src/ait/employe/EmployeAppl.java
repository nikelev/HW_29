...
import ait.employe.model.Employee;
import ait.employe.model.Maneger;
import ait.employe.model.SalesManager;
import ait.employe.model.WageEmployee;
...
public class EmployeAppl {
    ...
    public static double tatalSalary(Employee[] employees) {
        double sum = 0;
        for (int i = 0; i < employees.length; i++) {
            if (employees[i] != null) {
